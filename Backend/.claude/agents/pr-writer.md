...
tools: Read, Glob, Bash, mcp__github__create_pull_request, mcp__github__push_files, mcp__github__create_branch, mcp__github__list_pull_requests, mcp__github__get_pull_request
model: sonnet
skills: create-pr
---
