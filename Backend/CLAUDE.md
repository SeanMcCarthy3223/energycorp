...
See module-level `CLAUDE.md` files for detailed app documentation:
- `src/users/CLAUDE.md` — Auth, permissions, CustomUser model, login endpoint
- `src/contract/CLAUDE.md` — Invoice logic, contract model, serializer patterns
