...
allowed-tools: Bash, mcp__github__create_pull_request, mcp__github__create_branch, mcp__github__list_pull_requests, mcp__github__get_pull_request
context: fork
...
2. **Commit**: `git commit -m "<message>"` (use a HEREDOC for multi-line messages)
